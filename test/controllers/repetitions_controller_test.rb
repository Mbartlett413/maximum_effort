...
class RepetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create repetition" do
    assert_difference('Repetition.count') do
      post repetitions_url, params: { repetition: { title: @repetition.title, user_id: @repetition.user_id } }
    end
  ...
  test "should update repetition" do
    patch repetition_url(@repetition), params: { repetition: { title: @repetition.title, user_id: @repetition.user_id } }
