...
class MuscleGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create muscle_group" do
    assert_difference('MuscleGroup.count') do
      post muscle_groups_url, params: { muscle_group: { primary_muscle: @muscle_group.primary_muscle, secondary_muscle_string: @muscle_group.secondary_muscle_string, title: @muscle_group.title } }
    end
  ...
  test "should update muscle_group" do
    patch muscle_group_url(@muscle_group), params: { muscle_group: { primary_muscle: @muscle_group.primary_muscle, secondary_muscle_string: @muscle_group.secondary_muscle_string, title: @muscle_group.title } }
