...
class MaxEffortsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create max_effort" do
    assert_difference('MaxEffort.count') do
      post max_efforts_url, params: { max_effort: { exercise_id: @max_effort.exercise_id, max_value: @max_effort.max_value, user_id: @max_effort.user_id } }
    end
  ...
  test "should update max_effort" do
    patch max_effort_url(@max_effort), params: { max_effort: { exercise_id: @max_effort.exercise_id, max_value: @max_effort.max_value, user_id: @max_effort.user_id } }
